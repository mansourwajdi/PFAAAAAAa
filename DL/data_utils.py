...
if __name__ == '__main__':
    train_loader = ASVDataset(LOGICAL_DATA_ROOT, is_train=True, feature_name="mfcc")
    assert len(train_loader) == 25380, 'Incorrect size of training set.'
    dev_loader = ASVDataset(LOGICAL_DATA_ROOT, is_train=False, feature_name="mfcc")
